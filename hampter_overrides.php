...
class Hampter_Overrides extends Module
{
    ...
    public function hookDisplayHeader($params)
    {
        ...
        $scripts .= '      var paypalRadios = document.querySelectorAll(\'input[data-module-name="paypal"]\');' . PHP_EOL;
        ...
        $scripts .= '      if (typeof Shortcut === "undefined") {' . PHP_EOL;
        ...
        $scripts .= '      if (paypalShortcutState.buttonInitialized) {' . PHP_EOL;
        $scripts .= '        return;' . PHP_EOL;
        $scripts .= '      }' . PHP_EOL;
        $scripts .= '      var selectedPaypal = document.querySelector(\'input[data-module-name="paypal"]:checked\');' . PHP_EOL;
        $scripts .= '      var buttonContainer = document.querySelector(\'[paypal-button-container]\');' . PHP_EOL;
        $scripts .= '      if (!selectedPaypal || !buttonContainer) {' . PHP_EOL;
        $scripts .= '        return;' . PHP_EOL;
        $scripts .= '      }' . PHP_EOL;
        $scripts .= '      if (buttonContainer.offsetParent === null && buttonContainer.style.visibility !== "visible") {' . PHP_EOL;
        $scripts .= '        return;' . PHP_EOL;
        $scripts .= '      }' . PHP_EOL;
        ...
        $scripts .= '      var paypalRadios = document.querySelectorAll(\'input[data-module-name="paypal"], input[name="payment-option"]\');' . PHP_EOL;
        $scripts .= '      paypalRadios.forEach(function (radio) { radio.addEventListener(\'change\', hampterUpdatePaypalButtonVisibility); });' . PHP_EOL;
